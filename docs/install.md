...
```sh
cd ~/Downloads
curl -L https://github.com/arreyder/compliance-masonry/releases/download/v1.1.2/compliance-masonry_1.1.2_darwin_amd64.zip -o compliance-masonry.zip
...
1. Go to [the Github Release](https://github.com/arreyder/compliance-masonry/releases/tag/v1.1.2).
...
The instructions below are for 64-bit architectures. See the [releases](https://github.com/arreyder/compliance-masonry/releases) page for others.

In your terminal, run the following:

```sh
curl -L https://github.com/arreyder/compliance-masonry/releases/download/v1.1.2/compliance-masonry_1.1.2_linux_amd64.tar.gz -o compliance-masonry.tar.gz
